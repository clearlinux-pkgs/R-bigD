...
Version  : 0.3.1
Release  : 7
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/bigD_0.3.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/bigD_0.3.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743782663
